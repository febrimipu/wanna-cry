...
!(function (t) {
  ...
  function xt(t) {
    return ((kt(t) ? t.ownerDocument : t.document) || window.document)
      .documentElement;
  }
  function Bt(t) {
    return "html" === yt(t)
    ...
    _setListeners() {
      (this._config.trigger.split(" ").forEach((t) => {
        if ("click" === t)
          ...
          (un.on(this._element, e, this._config.selector, (t) =>
            this._enter(t),
          ),
